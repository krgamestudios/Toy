...
int test_value_creation(void) {
	...
	//test creating strings
	{
		...
		Toy_Value greeting = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "Hello world!", 12));
...
int test_value_hashing(void) {
	//test value hashing
	{
		...
		//skip float
		Toy_Value s = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "Hello world", 11));
...
int test_value_equality(void) {
	...
	//again with strings
	{
		...
		Toy_Value answer = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "poe wrote on both", 17));
		Toy_Value question = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "why is a raven like a writing desk?", 35));
		Toy_Value duplicate = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "poe wrote on both", 17));
...
int test_value_stringify(void) {
	...
	//stringify strings
	{
		...
		Toy_Value value = TOY_VALUE_FROM_STRING(Toy_createStringLength(&bucket, "Hello world!", 12));
		Toy_String* string = Toy_stringifyValue(&bucket, value);
